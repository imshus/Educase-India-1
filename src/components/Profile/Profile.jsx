...
const Profile = () => {
  ...
  return (
    <div className="flex justify-center items-center h-screen">
            <div className="flex flex-col justify-start lg:border lg:border-gray-300 lg:shadow-md lg:w-1/4 min-h-[83%]">
                ...
                <div className="border border-gray-200 p-4 rounded">
                    <div className="flex">
                        ...
                        <span className="pl-4">
                            <p id="profile-name" className="text-lg font-bold text-xs">{user ? user.fullName : "Guest User"}</p>
                            <p className="text-xs">{user ? user.email : "No email available"}</p>
                        </span>
                    </div>
